...
class SkillRequirement extends Requirement {
    ...
    text() {
        return "已学会 " +  $dataSkills[this.lvls[this.lvl - 1]].name;
    }
}
...
combatReflexes = skill([11, 12, 13], [ // Skill IDs from database skills.
    [cost(3)],                         // Skill requirement for 1 level (skill ID = 11)
    [cost(5)],                         // Skill requirement for 2 level (skill ID = 12)
    [cost(7)]                          // Skill requirement for 3 level (skill ID = 13)
]);
dualAttack = skill([3], [
    [cost(1)] // Skill cost 1 skill point and requires 'combatReflexes' skill
]);                                        // learned at 1 level. Level can be skipped, see next skill.
doubleAttack = skill([4], [
    [cost(1)] // Same as above, but can be learned by heroes with level 3 or above.
]);
tripleAttack = skill([5], [
    [cost(3), lvl(5)] // Requires 2 skills.
]);
berserkerDance = skill([14], [
    [cost(7), skillReq(doubleAttack), skillReq(combatReflexes, 3)] // Requires 2 consumable items with ID 1.
]);
rampage = skill([15], [
    [cost(7), skillReq(combatReflexes, 3), skillReq(dualAttack)]
]);
armorBreak = skill([8, 9, 10], [
    [cost(3)],
    [cost(5)],
    [cost(7), itemReq('item', 1, 5)]
]);
spark = skill([16], [
    [cost(1)]
]);
...
wanwu = skill([21], [
    [cost(7), skillReq(armorBreak, 3)]
]);

guangdan = skill([22, 23, 24], [
    [cost(3)],
    [cost(5)],
    [cost(7)]
]);
...
SkillTreesSystem.class2trees = {
    1: new SkillTrees(11,
        [new SkillTree('战士', 'Class 1', [
            // Null represents empty square in the skill window.
            // Arrow points from one skill to another.
            null,   dualAttack,        null,          null,               null,             doubleAttack,        null,
            null,   null,              arrowRight,    null,               arrowLeft,        null,                null,
            null,   null,              null,          tripleAttack,       null,             null,                null,
            null,   null,              null,          arrowDown,          null,             null,                null,
            null,   null,              null,          combatReflexes,     null,             null,                null,
            null,   null,              arrowLeft,     null,               arrowRight,       null,                null,
            null,   berserkerDance,    null,          null,               null,             rampage,             null,
            null,   null,              null,          null,               null,             null,                null,
            null,   null,              null,          null,               null,             null,                null,
        ])]
    ),
    2:  new SkillTrees(12,
        [new SkillTree('法师', 'Class 2', [
            null,   null,           null,          null,               null,       null,            null,
            null,   spark,          null,          null,               null,       shushi,          null,
            null,   null,           arrowRight,    null,               arrowLeft,  null,            null,
            null,   null,           null,          guangdan,           null,       null,            null,
            null,   null,           null,          arrowDown,          null,       null,            null,
            null,   null,           null,          jiushu,             null,       null,            null,
            null,   null,           null,          null,               null,       null,            null,
            null,   null,           null,          null,               null,       null,            null,
            null,   null,           null,          null,               null,       null,            null,
        ])]
    ...
    4:  new SkillTrees(14,
        [new SkillTree('治疗师', 'Class 4', [
            null,   null,           null,          null,               null,       null,            null,
            null,   null,           armorBreak,    null,              jiedu,       null,            null,
            null,   null,           null,          null,               null,       null,            null,
            null,   null,           null,          null,               null,       null,            null,
            null,   null,           null,          null,               null,       null,            null,
            null,   null,           null,          null,               null,       null,            null,
