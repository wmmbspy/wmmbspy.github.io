...
/*:
 * @plugindesc (v2.0 *) Adiciona efeitos animados nos battlers.
 * @author Moghunter
 *
...
Game_Action.prototype.prepare = function() {	
	...
	if (this.canBmotionAction(this._item)){
		this.subject().prepareBmotionAction(this._item)
...
//==============================
Game_Battler.prototype.prepareBmotionAction = function(item) {
